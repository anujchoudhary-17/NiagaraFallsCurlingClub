...
public class LeagueSelectionController {
    ...
    public String saveMembershipInfo(Model model, @ModelAttribute Tournament tournamentData,
            RedirectAttributes redirectAttrs, @ModelAttribute("user") User userWithLeagueId) {

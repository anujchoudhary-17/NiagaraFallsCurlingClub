...
public class SignUpController {
	...
	public String save(ModelMap model, @RequestParam String firstName, @RequestParam String lastName,
			@RequestParam String email, @RequestParam String phoneNumber,
			@RequestParam String password) {
		if (!validateUserData(model, firstName, lastName, email, phoneNumber, password)) {
			return "views/signUp";
		} else {
	...
	public boolean validateUserData(ModelMap model, String firstName, String lastName, String email, String phoneNumber,
			String password) {
